/***
    ...
    Taken from: https://github.com/fizyr/dr_eigen

    Quaternion averaging is performed using EVD according to
        [1] F. L. Markley, Y. Cheng, J. L. Crassidis, and Y. Oshman, 
            “Quaternion Averaging,” NASA Goddard Sp. Flight Cent., pp. 1–10, 2007.
